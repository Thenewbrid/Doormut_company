...
const HomeHeader = () => {
  ...
  return (
    <div className="w-full flex items-center justify-center z-50 top-0 h-[100vh]">
      <div className="w-full flex items-center justify-center relative z-50 -top-0 h-[100vh]">
        {/* BANNER */}
        <img className="w-full hidden md:flex h-full object-cover" src={bg} />
        <img className="w-full flex md:hidden h-full object-cover" src={bg2} />
        <div className="w-full absolute h-full bg-tranparent left-7 md:left-20 items-left justify-center flex flex-col gap-10">
          {/* LOGO */}
          <img src={logo} className="w-40 top-20 absolute" />
          <div className="flex flex-col items-start justify-start gap-14 md:gap-28">
            {/* TPEWRITER */}
            <div className="relative mb-9 mt-2  w-[90%] md:w-full">
              <div className="flex absolute -ml-1 w-[140%] md:w-full">
                <Typewriter
                  options={{
                    strings: [
                      '<span class="text-white font-extrabold font-Quicksand text-[28px] xl:text-[56px] md:text-[40px]">We Are Coming Soon</span>',
                      '<span class="text-[#f79e1b] font-extrabold font-Quicksand text-[23px] xl:text-[52px] md:text-[40px]">Online shopping experience...</span>',
                      '<span class="text-[#f79e1b] font-extrabold font-Quicksand text-[23px] xl:text-[52px] md:text-[40px]">For Groceries...</span>',
                      '<span class="text-[#f79e1b] font-extrabold font-Quicksand text-[23px] xl:text-[52px] md:text-[40px]">Personal care products,etc.</span>',
                      '<span class="text-[#3bb77e] font-extrabold font-Quicksand text-[23px] xl:text-[52px] md:text-[40px]">Sell fast on doormut</span>',
                      '<span class="text-[#3bb77e] font-extrabold font-Quicksand text-[23px] xl:text-[52px] md:text-[40px]">Earn as dispatch</span>',
                      '<span class="text-[#3bb77e] font-extrabold font-Quicksand text-[23px] xl:text-[52px] md:text-[40px]">Partener with us</span>',
                    ],
                    autoStart: true,
                    loop: true,
                    deleteSpeed: 70,
                    cursorClassName: "active text-white",
                    delay: 50,
                  }}
                />
              </div>
            ...
            <form
              ref={form}
              onSubmit={sendEmail}
              className="bg-white z-10 w-[22rem] xl:w-[35rem] md:w-[35rem] h-[3.3rem] rounded-[28px] flex items-center justify-between -ml-1 xl:ml-0 md:ml-0"
            >
              <input
          ...
          <div className=" flex items-center justify-start flex-row gap-20 md:gap-28 xl:gap-44 absolute bottom-16 lg:bottom-9 md:bottom-24">
            {/* FOLLOW US */}
            <div className=" flex items-left justify-center flex-col gap-5 md:gap-4 xl:gap-6">
            ...
            {/* CONTACT US */}
            <div className=" flex items-left justify-center flex-col gap-5 md:gap-2 xl:gap-6 ">
              <h2 className=" text-white font-Quicksand font-semibold text-[16px] md:text-[25px]  xl:text-[28px]">
                Contact Us
              </h2>
              <div className="flex max-md:items-left md:items-center max-md:justify-start md:justify-center xl:justify-center flex-col md:flex-row gap-3 md:gap-6 xl:md:gap-16 ">
    ...
    //   <img
    //     className="w-full contrast-100 backdrop-contrast-150 z-10 absolute hidden xl:flex md:flex md:-top-[0.0%] object-cover"
    //     src={bg}
    //   />
    //   <img
    //     className="w-full contrast-100 backdrop-contrast-150 contrast-70 z-10 absolute flex xl:hidden md:hidden -top-[0.1%] object-cover"
    //     src={bg2}
    //   />
