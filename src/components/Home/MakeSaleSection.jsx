...
const MakeSaleSection = () => {
  return (
    <div className="flex items-center overflow-hidden justify-center bg-white landscape:gap-44 gap-28 xl:gap-40 md:gap-20 mt-24 flex-col xl:flex-row md:flex-row w-full p-5 xl:p-10 md:p-[1.7rem] mb-28 ">
      {/* image section */}
      <img
      data-aos="zoom-in"
        src={sales}
      ...
      {/* text/button section */}
      <div className="flex items-left justify-center p-1 xl:p-2 md:p-2 w-full xl:w-[35rem] md:w-[31rem] -mt-12 xl:-mt-12 md:-mt-2 gap-3 md:gap-3 xl:gap-3 flex-col landscape:ml-12">
